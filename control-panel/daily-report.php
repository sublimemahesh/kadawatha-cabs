...
<html> 
    <head>
        ...
        <title>Booking Report|| WEB SITE CONTROL PANEL </title>
        <!-- Favicon-->
    ...
    <body class="theme-red">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            ...
                            <div class="body">
                                ...
                                <div>
                                    <table class="table table-bordered table-striped table-hover js-basic-example dataTable sales-report-table" id="daily-report">
                                        <thead>
                                            <tr>
                                                <th>ID</th>
                                                <th>Create date</th>
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <th id="total-cost" class="text-right bold"></th>
                                            </tr>
                                        </tfoot>
                                        <tbody>
        ...
        <script src="js/daily-report.js" type="text/javascript"></script>
        <script>
            $(function () {
